...
echo -------------------------------------------------------------------------------
echo [1] Instalacion de Docker (ESENCIAL)
echo    > Abre la web de Docker para realizar la instalacion.
echo [2] Configurar protocolo Acestream en Windows (OPCIONAL)
...
echo ----------------------------------------
echo Abriendo la pagina oficial de Docker...
echo Por favor, sigue las instrucciones en el sitio web para completar la instalacion de Docker.
echo Una vez finalizada la instalacion, regresa a este asistente para continuar.
start https://www.docker.com/get-started/
echo ----------------------------------------
echo Esperando a que completes la instalacion de Docker...
pause
goto menu
